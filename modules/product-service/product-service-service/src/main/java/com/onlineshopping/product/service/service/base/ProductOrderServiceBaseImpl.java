...
import com.onlineshopping.product.service.service.ProductOrderService;
...
/**
 * Provides the base implementation for the product order remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.ProductOrderServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.ProductOrderServiceImpl
 * @generated
 */
public abstract class ProductOrderServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, ProductOrderService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductOrderService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductOrderServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(productOrderService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductOrderService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProductOrderServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, productOrderService);
		}
	...
	@BeanReference(type = ProductOrderService.class)
