...
import com.onlineshopping.product.service.service.CartListService;
...
/**
 * Provides the base implementation for the cart list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.CartListServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.CartListServiceImpl
 * @generated
 */
public abstract class CartListServiceBaseImpl
	extends BaseServiceImpl
	implements CartListService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CartListService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CartListServiceUtil</code>.
	 */
	 ...
	 */
	public CartListService getCartListService() {
	 ...
	 */
	public void setCartListService(CartListService cartListService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(cartListService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CartListService.class.getName();
	}
	...
	private void _setServiceUtilService(CartListService cartListService) {
		try {
			Field field = CartListServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cartListService);
		}
	...
	@BeanReference(type = CartListService.class)
	protected CartListService cartListService;
