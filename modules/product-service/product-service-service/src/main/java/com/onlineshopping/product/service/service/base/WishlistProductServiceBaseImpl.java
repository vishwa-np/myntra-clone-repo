...
import com.onlineshopping.product.service.service.WishlistProductService;
...
/**
 * Provides the base implementation for the wishlist product remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.WishlistProductServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.WishlistProductServiceImpl
 * @generated
 */
public abstract class WishlistProductServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, WishlistProductService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WishlistProductService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WishlistProductServiceUtil</code>.
	 */
	 ...
	 */
	public WishlistProductService getWishlistProductService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(wishlistProductService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WishlistProductService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = WishlistProductServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, wishlistProductService);
		}
	...
	@BeanReference(type = WishlistProductService.class)
	protected WishlistProductService wishlistProductService;
