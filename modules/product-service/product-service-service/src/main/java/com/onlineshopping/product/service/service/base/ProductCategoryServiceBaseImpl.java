...
import com.onlineshopping.product.service.service.ProductCategoryService;
...
/**
 * Provides the base implementation for the product category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.ProductCategoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.ProductCategoryServiceImpl
 * @generated
 */
public abstract class ProductCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, ProductCategoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductCategoryServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(productCategoryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductCategoryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProductCategoryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, productCategoryService);
		}
