...
import com.onlineshopping.product.service.service.ProductCategoryLocalService;
...
/**
 * Provides the base implementation for the product category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.ProductCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.ProductCategoryLocalServiceImpl
 * @generated
 */
public abstract class ProductCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, ProductCategoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductCategoryLocalServiceUtil</code>.
	 */
	...
	public ProductCategory addProductCategory(ProductCategory productCategory) {
		...
		return productCategoryPersistence.update(productCategory);
	}
	...
	public ProductCategory createProductCategory(long id) {
		return productCategoryPersistence.create(id);
	}
	...
	public ProductCategory deleteProductCategory(long id)
		...
		return productCategoryPersistence.remove(id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProductCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return productCategoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return productCategoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProductCategory fetchProductCategory(long id) {
		return productCategoryPersistence.fetchByPrimaryKey(id);
	}
	...
	public ProductCategory getProductCategory(long id) throws PortalException {
		return productCategoryPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(productCategoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProductCategory.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ProductCategory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return productCategoryLocalService.deleteProductCategory(
			(ProductCategory)persistedModel);
	}

	public BasePersistence<ProductCategory> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(productCategoryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductCategoryLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProductCategoryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, productCategoryLocalService);
		}
