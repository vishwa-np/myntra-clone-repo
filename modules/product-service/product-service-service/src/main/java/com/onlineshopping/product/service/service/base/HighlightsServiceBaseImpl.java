...
import com.onlineshopping.product.service.service.HighlightsService;
...
/**
 * Provides the base implementation for the highlights remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.HighlightsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.HighlightsServiceImpl
 * @generated
 */
public abstract class HighlightsServiceBaseImpl
	extends BaseServiceImpl
	implements HighlightsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HighlightsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HighlightsServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(highlightsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HighlightsService.class.getName();
	}
	...
	private void _setServiceUtilService(HighlightsService highlightsService) {
		try {
			Field field = HighlightsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, highlightsService);
		}
	...
	@BeanReference(type = HighlightsService.class)
