...
import com.onlineshopping.product.service.service.WishlistLocalService;
...
/**
 * Provides the base implementation for the wishlist local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.WishlistLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.WishlistLocalServiceImpl
 * @generated
 */
public abstract class WishlistLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, WishlistLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WishlistLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WishlistLocalServiceUtil</code>.
	 */
	...
	public Wishlist addWishlist(Wishlist wishlist) {
		...
		return wishlistPersistence.update(wishlist);
	}
	...
	public Wishlist createWishlist(long id) {
		return wishlistPersistence.create(id);
	}
	...
	public Wishlist deleteWishlist(long id) throws PortalException {
		return wishlistPersistence.remove(id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Wishlist.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return wishlistPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return wishlistPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Wishlist fetchWishlist(long id) {
		return wishlistPersistence.fetchByPrimaryKey(id);
	}
	...
	public Wishlist getWishlist(long id) throws PortalException {
		return wishlistPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(wishlistLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Wishlist.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Wishlist.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return wishlistLocalService.deleteWishlist((Wishlist)persistedModel);
	}

	public BasePersistence<Wishlist> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.onlineshopping.product.service.model.Wishlist",
			wishlistLocalService);

		_setLocalServiceUtilService(wishlistLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WishlistLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = WishlistLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, wishlistLocalService);
		}
