...
import com.onlineshopping.product.service.service.CartListLocalService;
...
/**
 * Provides the base implementation for the cart list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.CartListLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.CartListLocalServiceImpl
 * @generated
 */
public abstract class CartListLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CartListLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CartListLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CartListLocalServiceUtil</code>.
	 */
	...
	public CartList addCartList(CartList cartList) {
		...
		return cartListPersistence.update(cartList);
	}
	...
	public CartList createCartList(long id) {
		return cartListPersistence.create(id);
	}
	...
	public CartList deleteCartList(long id) throws PortalException {
		return cartListPersistence.remove(id);
	}
	...
	public CartList deleteCartList(CartList cartList) {
		return cartListPersistence.remove(cartList);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CartList.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cartListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cartListPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cartListPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return cartListPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CartList fetchCartList(long id) {
		return cartListPersistence.fetchByPrimaryKey(id);
	}
	...
	public CartList getCartList(long id) throws PortalException {
		return cartListPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cartListLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CartList.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CartList.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return cartListLocalService.deleteCartList((CartList)persistedModel);
	}

	public BasePersistence<CartList> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return cartListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CartList> getCartLists(int start, int end) {
		return cartListPersistence.findAll(start, end);
	}
	...
	public int getCartListsCount() {
		return cartListPersistence.countAll();
	}
	 ...
	 */
	public CartListLocalService getCartListLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.onlineshopping.product.service.model.CartList",
			cartListLocalService);

		_setLocalServiceUtilService(cartListLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CartListLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cartListPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CartListLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cartListLocalService);
		}
	...
	@BeanReference(type = CartListLocalService.class)
	protected CartListLocalService cartListLocalService;
