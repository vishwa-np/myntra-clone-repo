...
import com.onlineshopping.product.service.service.CartListProductService;
...
/**
 * Provides the base implementation for the cart list product remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.CartListProductServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.CartListProductServiceImpl
 * @generated
 */
public abstract class CartListProductServiceBaseImpl
	extends BaseServiceImpl
	implements CartListProductService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CartListProductService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CartListProductServiceUtil</code>.
	 */
	 ...
	 */
	public CartListProductService getCartListProductService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(cartListProductService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CartListProductService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = CartListProductServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cartListProductService);
		}
	...
	@BeanReference(type = CartListProductService.class)
	protected CartListProductService cartListProductService;
