...
import com.onlineshopping.product.service.service.BrandService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.BrandServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.BrandServiceImpl
 * @generated
 */
public abstract class BrandServiceBaseImpl
	extends BaseServiceImpl implements BrandService, IdentifiableOSGiService {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(brandService);
	}
	...
	private void _setServiceUtilService(BrandService brandService) {
		try {
			Field field = BrandServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, brandService);
		}
	...
	@BeanReference(type = BrandService.class)
