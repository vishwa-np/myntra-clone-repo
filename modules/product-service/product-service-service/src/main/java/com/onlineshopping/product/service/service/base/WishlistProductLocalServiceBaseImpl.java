...
import com.onlineshopping.product.service.service.WishlistProductLocalService;
...
/**
 * Provides the base implementation for the wishlist product local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.WishlistProductLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.WishlistProductLocalServiceImpl
 * @generated
 */
public abstract class WishlistProductLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, WishlistProductLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WishlistProductLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WishlistProductLocalServiceUtil</code>.
	 */
	...
	public WishlistProduct addWishlistProduct(WishlistProduct wishlistProduct) {
		...
		return wishlistProductPersistence.update(wishlistProduct);
	}
	...
	public WishlistProduct createWishlistProduct(long id) {
		return wishlistProductPersistence.create(id);
	}
	...
	public WishlistProduct deleteWishlistProduct(long id)
		...
		return wishlistProductPersistence.remove(id);
	}
	...
	public WishlistProduct deleteWishlistProduct(
		...
		return wishlistProductPersistence.remove(wishlistProduct);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WishlistProduct.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return wishlistProductPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return wishlistProductPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return wishlistProductPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return wishlistProductPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WishlistProduct fetchWishlistProduct(long id) {
		return wishlistProductPersistence.fetchByPrimaryKey(id);
	}
	...
	public WishlistProduct getWishlistProduct(long id) throws PortalException {
		return wishlistProductPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(wishlistProductLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WishlistProduct.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(WishlistProduct.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return wishlistProductLocalService.deleteWishlistProduct(
			(WishlistProduct)persistedModel);
	}

	public BasePersistence<WishlistProduct> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return wishlistProductPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<WishlistProduct> getWishlistProducts(int start, int end) {
		return wishlistProductPersistence.findAll(start, end);
	}
	...
	public int getWishlistProductsCount() {
		return wishlistProductPersistence.countAll();
	}
	 ...
	 */
	public WishlistProductLocalService getWishlistProductLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(wishlistProductLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WishlistProductLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = wishlistProductPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				WishlistProductLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, wishlistProductLocalService);
		}
	...
	@BeanReference(type = WishlistProductLocalService.class)
	protected WishlistProductLocalService wishlistProductLocalService;
