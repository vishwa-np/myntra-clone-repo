...
import com.onlineshopping.product.service.service.BrandLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.onlineshopping.product.service.service.impl.BrandLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.onlineshopping.product.service.service.impl.BrandLocalServiceImpl
 * @generated
 */
public abstract class BrandLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements BrandLocalService, IdentifiableOSGiService {
	...
	public Brand createBrand(long id) {
		return brandPersistence.create(id);
	}
	...
	public Brand deleteBrand(long id) throws PortalException {
		return brandPersistence.remove(id);
	}
	...
	public Brand fetchBrand(long id) {
		return brandPersistence.fetchByPrimaryKey(id);
	}
	...
	public Brand getBrand(long id) throws PortalException {
		return brandPersistence.findByPrimaryKey(id);
	}
	 ...
	 */
	public BrandLocalService getBrandLocalService() {
	 ...
	 */
	public void setBrandLocalService(BrandLocalService brandLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.onlineshopping.product.service.model.Brand",
			brandLocalService);
	...
	@BeanReference(type = BrandLocalService.class)
