...
public class ProductUtil {
	...
	public static Product fetchByProductDetails(
		...
		return getPersistence().fetchByProductDetails(
			productName, color, gender, brandId, highlightsId, useFinderCache);
	}
