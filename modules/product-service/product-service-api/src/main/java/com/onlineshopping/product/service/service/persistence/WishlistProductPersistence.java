...
/**
 * The persistence interface for the wishlist product service.
 *
 * <p>
 ...
 * @see WishlistProductUtil
 * @generated
 */
@ProviderType
public interface WishlistProductPersistence
	extends BasePersistence<WishlistProduct> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WishlistProductUtil} to access the wishlist product persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	@Override
	 ...
	 */
	public void cacheResult(java.util.List<WishlistProduct> wishlistProducts);
	 ...
	 */
	public java.util.List<WishlistProduct> findAll();
	 ...
	 */
	public java.util.List<WishlistProduct> findAll(int start, int end);
	...
	public java.util.List<WishlistProduct> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WishlistProduct>
			orderByComparator);
