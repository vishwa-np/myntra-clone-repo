...
/**
 * Provides the local service interface for CartList. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CartListLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CartListLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.onlineshopping.product.service.service.impl.CartListLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cart list local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CartListLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CartList addCartList(CartList cartList);
	...
	public CartList createCartList(long id);
	...
	public CartList deleteCartList(CartList cartList);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CartList deleteCartList(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CartList fetchCartList(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CartList getCartList(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CartList> getCartLists(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CartList updateCartList(CartList cartList);
