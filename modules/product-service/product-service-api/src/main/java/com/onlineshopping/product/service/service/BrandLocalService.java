...
public interface BrandLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.onlineshopping.product.service.service.impl.BrandLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the brand local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BrandLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Brand createBrand(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Brand deleteBrand(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Brand getBrand(long id) throws PortalException;
